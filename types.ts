/**
 * CNA SYSTEM TYPES - 2026 STABLE VERSION
 */

// 1. GLOBAL NAVIGATION TYPES
export type View = 'organisational' | 'individual' | 'pathways' | 'gesi' | 'cna' | 'settings' | 'survey-insights';
export type Tab = 'diagnostic' | 'overview' | 'divisional';
...
// 2. 10:20:70 LEARNING MODEL INTERFACES
...
export interface AiTrainingPathwayReport {
  ...
  pathwaysByGrade?: any[]; // Merged from duplicate definition
}
