...
export const LoginPage: React.FC<LoginPageProps> = ({ onLoginSuccess }) => {
    // Both states now start completely empty
    ...
    const handleLogin = (e: React.FormEvent) => {
        ...
        // Authorization Logic - Credentials remain private in the code
        ...
        <div className="relative min-h-screen w-full flex items-center justify-center bg-[#F1F5F9] overflow-hidden font-sans" 
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <img 
                    ...
                    className="w-[80%] max-w-[850px] h-auto opacity-[0.07] grayscale contrast-125" 
                    alt="Background Watermark" 
                />
            </div>

            {/* LOGIN CARD */}
            <div className="relative z-10 w-full max-w-md p-10 bg-white shadow-[0_20px_50px_rgba(0,0,0,0.1)] rounded-[2.5rem] border border-slate-200/60">
                ...
                <form className="space-y-6" onSubmit={handleLogin}>
                    <div className="space-y-2">
                        ...
                        <input 
                            ...
                            placeholder="Enter Username" // Generic placeholder for security
                            required
                        />
                    </div>
                    <div className="space-y-2">
